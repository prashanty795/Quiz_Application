...
urlpatterns = [
    ...
    path('admin-upload-question', views.admin_upload_question_view,name='admin-upload-question'),
    path('admin-confirm-upload-question', views.admin_confirm_upload_question_view,name='admin-confirm-upload-question'),
